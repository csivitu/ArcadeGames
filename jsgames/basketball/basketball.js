...
function player_play() {
    ...
    while (1) {
        ...
        if (7 / d * Math.random() <= 0.7) {
            ...
            print("VIT CONTROLS THE REBOUND.\n");
            if (Math.random() <= 0.4)
                continue;
            print("BALL PASSED BACK TO YOU.\n");
            your_turn = 1;
...
// Main program
async function main() {
    print(tab(7) + "BASKETBALL\n");
    print( "COMPUTER SOCIETY INDIA - VIT\n");
    print("\n");
    print("\n");
    print("\n");
    print("THIS IS VIT COLLEGE BASKETBALL.  YOU WILL BE VIT\n");
    ...
    while (1) {
        ...
        if (Math.random() < 0.5 || t < 100) {
            ...
            if (s[1] == s[0]) {
                ...
                print("   ***** END OF GAME *****\n");
                print("FINAL SCORE: VIT: " + s[1] + "  " + os + ": " + s[0] + "\n");
                break;
            }
        }
    }
